...
sample_rate, signal = scipy.io.wavfile.read('./data/1028-20100710-hne/wav/ar-01.wav')  # File assumed to be in the same directory
...
for i in range(len(signal_modified)//req_samples):
    ...
    np.save('audio' + str(i) + '.npy', pow_frames)